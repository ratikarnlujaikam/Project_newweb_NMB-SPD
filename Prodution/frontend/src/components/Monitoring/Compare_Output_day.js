...
class Compare_Output_day extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = async () => {
    ...
    const { state } = location || {}; // Default to an empty object if location is undefined
    ...
    try {
      ...
      let options = {
        ...
        tooltip: {
          ...
          followCursor: true, // ให้ tooltip ติดตามเมาส์
          fixed: {
            enabled: false, // ปิด fixed
          },
        },
        ...
        dataLabels: {
          enabled: true,
          enabledOnSeries: undefined, // Display data labels on all series
          offsetX: 0,
          offsetY: 0,
          style: {
            fontSize: "11px",
          ...
          formatter: function (val) {
            return Number(val).toFixed(2) + "%"; // Format value as percentage with 2 decimal places
          },
          yAxisIndex: 0, // Set the yAxisIndex to 0 for the left side
        },
        ...
        xaxis: {
          categories: xAxis, // Make sure xAxis is defined elsewhere in your code
        },
        yaxis: yaxisConfig, // Ensure yaxisConfig is defined elsewhere in your code
        colors: [
          "#993366",
          "#ff7f0e",
          "#2ca02c",
...
export default Compare_Output_day;
