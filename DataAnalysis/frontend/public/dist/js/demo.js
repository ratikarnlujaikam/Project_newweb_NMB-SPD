...
// // ตรวจสอบการทำงานของฟังก์ชัน capitalizeFirstLetter
// function capitalizeFirstLetter(string) {
//   if (typeof string !== 'string' || string.length === 0) return '';
//   return string.charAt(0).toUpperCase() + string.slice(1);
// }

// // ตรวจสอบการทำงานของ createSkinBlock
...
//     var className = (typeof color === 'object' ? color.join(' ') : color).replace('navbar-', 'bg-').replace('accent-', 'bg-');
//     var text = capitalizeFirstLetter((typeof color === 'object' ? color.join(' ') : color).replace(/navbar-|accent-|bg-/, '').replace('-', ' '));
//     var $color = $('<option />', {
//       class: className,
//       text: text
//     });
...
// // ตรวจสอบการทำงานของ checkboxes
// function toggleClassBasedOnCheckbox(selector, className) {
//   $(selector).toggleClass(className, $(this).is(':checked'));
// }
...
//   class: 'mr-1'
// }).on('click', function () {
//   toggleClassBasedOnCheckbox('body', 'dark-mode');
// });
